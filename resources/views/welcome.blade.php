        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav text-uppercase ml-auto">
                    ...
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#capacitacion">Capacitaciones</a>
                    </li>
    ...
    <header class="masthead">
        <div class="container">
            <a class=" masthead-subheading">
                <img src="{!! asset('assets/img/logos/LOGO_EMCO.png') !!}" alt="EMCO logo" width="70%" style="margin-top: -100px" />
            </a>
                    ...
                    <div class="container">
                        <div class="map">
                            <div class="map__image">
                                ...
                                <svg id="mapa" xmlns="http://www.w3.org/2000/svg"
                                    xmlns:amcharts="http://amcharts.com/ammap"
                                    xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                                    preserveAspectRatio="xMidYMid meet" viewbox="30 60 800 550">

                                    <g>
                                        <path id="MX-AGU" title="Aguascalientes" class="land"
                                        ...
                                        <path id="MX-BCN" title="Baja California" class="land"
                                        ...
                                        <path id="MX-BCS" title="Baja California Sur" class="land"
                                        ...
                                        <path id="MX-CAM" title="Campeche" class="land"
                                        ...
                                        <path id="MX-CHP" title="Chiapas" class="land"
                                        ...
                                        <path id="MX-CHH" title="Chihuahua" class="land"
                                        ...
                                        <path id="MX-COA" title="Coahuila" class="land"
                                        ...
                                        <path id="MX-COL" title="Colima" class="land"
                                        ...
                                        <path id="MX-DF" title="Distrito Federal" class="land"
                                        ...
                                        <path id="MX-DUR" title="Durango" class="land"
                                        ...
                                        <path id="MX-GUA" title="Guanajuato" class="land"
                                        ...
                                        <path id="MX-GRO" title="Guerrero" class="land"
                                        ...
                                        <path id="MX-HID" title="Hidalgo" class="land"
                                        ...
                                        <a class="js-scroll-trigger" href="#cobertura">
                                            <path id="region-A" title="Jalisco" class="activeLand"
                                        ...
                                        <a class="js-scroll-trigger" href="#cobertura">
                                            <path id="MX-MEX" title="México" class="activeLand" href="#portfolioEdoMex"
                                        ...
                                        <path id="MX-MIC" title="Michoacán" class="land"
                                        ...
                                        <path id="MX-MOR" title="Morelos" class="land"
                                        ...
                                        <path id="MX-NA" title="Nayarit" class="land"
                                        ...
                                        <path id="MX-NLE" title="Nuevo León" class="land"
                                        ...
                                        <path id="MX-OAX" title="Oaxaca" class="land"
                                        ...
                                        <path id="MX-PUE" title="Puebla" class="land"
                                        ...
                                        <a class="js-scroll-trigger" href="#cobertura">
                                            <path id="MX-QUE" title="Querétaro" class="activeLand"
                                        ...
                                        <path id="MX-ROO" title="Quintana Roo" class="land"
                                        ...
                                        <a class="js-scroll-trigger" href="#cobertura">
                                            <path id="MX-SLP" title="San Luis Potosí" class="activeLand"
                                        ...
                                        <a class="js-scroll-trigger" href="#cobertura">
                                            <path id="MX-SIN" title="Sinaloa" class="activeLand"
                                        ...
                                        <path id="MX-SON" title="Sonora" class="land"
                                        ...
                                        <path id="MX-TAB" title="Tabasco" class="land"
                                        ...
                                        <path id="MX-TAM" title="Tamaulipas" class="land"
                                        ...
                                        <path id="MX-TLA" title="Tlaxcala" class="land"
                                        ...
                                        <a class="js-scroll-trigger" href="#cobertura">
                                            <path id="MX-VER" title="Veracruz" class="activeLand"
                                        ...
                                        <path id="MX-YUC" title="Yucatán" class="land"
                                        ...
                                        <path id="MX-ZAC" title="Zacatecas" class="land"
                        ...
                        <div class="carousel-item active">
                            <div class="row text-center justify-content-center">
                                <div class="card col-md-4 my-3 bg-dark">
                                    <span class="card-img-top fa-stack fa-5x">
                                        <i class="fas fa-circle fa-stack-2x text-primary"></i>
                ...
                <div class="col-lg-4 col-sm-6 mb-4">
                    <div class="portfolio-item">
                        <a class="portfolio-link" data-toggle="modal" href="#portfolioModal2">
                            ...
                            <div class="img-lg-y">
                                <img class="img-fluid" src="assets/img/portfolio/AmpliacionNaves/Captura11_2.png"
                                    alt="" />
                            </div>
                        </a>
                        <div class="portfolio-caption">
                ...
                <div class="col-lg-4 col-sm-6 mb-4">
                    <div class="portfolio-item">
                        <a class="portfolio-link" data-toggle="modal" href="#portfolioModal7">
                            ...
                            <div class="img-lg-y">
                                <img class="img-fluid" src="assets/img/portfolio/EstructuraBarcel/EstructuraBarcel7.PNG"
                                    alt="" />
                            </div>
                        </a>
                        <div class="portfolio-caption">
    ...
    <section class="page-section bg-dark" id="capacitacion">
        <div class="container">
            ...
            <div class="container row">
                <!-- Indicators -->
                <div class="card col-md-4 my-3 bg-dark">
                    <span class="card-img-top fa-stack fa-5x" style="height: 200px">
                        <i class="fas fa-circle fa-stack-2x text-primary"></i>
            ...
            <div class="text-center">
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6 my-3">
                        <img class="img-fluid d-block mx-auto" src="assets/img/logos/logo_grupo_bimbo.png"
                        alt="Bimbo" width="100" />
                    </div>
                    <div class="col-md-3 col-sm-6 my-3">
                        <img class="img-fluid d-block mx-auto" src="assets/img/logos/logo_tia_rosa.png"
                        alt="TiaRosa" width="100" />
                    </div>
                    <div class="col-md-3 col-sm-6 my-4">
                        <img class="img-fluid d-block mx-auto" src="assets/img/logos/logo_yakult.png"
                        alt="Yakult" width="100" />
                    </div>
                    <div class="col-md-3 col-sm-6 my-3">
                        <img class="img-fluid d-block mx-auto" src="assets/img/logos/logo_hazpan.png"
                        alt="" width="100" />
                    </div>
                    <div class="col-md-3 col-sm-6 my-3">
                        <img class="img-fluid d-block mx-auto" src="assets/img/logos/logo_barcel.png"
                        alt="" width="80" />
                    </div>
                    <div class="col-md-3 col-sm-6 my-2">
                        <img class="img-fluid d-block mx-auto" src="assets/img/logos/logo_suandy.png"
                        alt="" width="90" />
                    </div>
                    <div class="col-md-3 col-sm-6 my-3">
                        <img class="img-fluid d-block mx-auto" src="assets/img/logos/logo_rotoplas.png"
                        alt="" width="100" />
                    </div>
                    <div class="col-md-3 col-sm-6 my-3">
                        <img class="img-fluid d-block mx-auto" src="assets/img/logos/logo_sugar_foods.png"
                        alt="" width="100" />
                    </div>
                    <div class="col-md-3 col-sm-6 my-3">
                        <img class="img-fluid d-block mx-auto" src="assets/img/logos/logo_ricolino.png"
                        alt="" width="100" />
                    </div>
                    <div class="col-md-3 col-sm-6 my-3">
                        <img class="img-fluid d-block mx-auto" src="assets/img/logos/logo_sigma.png" alt=""
                        width="100" />
                    </div>
                    <div class="col-md-3 col-sm-6 my-3">
                        <img class="img-fluid d-block mx-auto" src="assets/img/logos/logo_hitachi.png"
                        alt="" width="100" />
                    </div>
                    <div class="col-md-3 col-sm-6 my-3">
                        <img class="img-fluid d-block mx-auto" src="assets/img/logos/logo_humbrall.png"
                        alt="" width="100" />
                    </div>
                    <div class="col-md-3 col-sm-6 my-3">
                        <img class="img-fluid d-block mx-auto" src="assets/img/logos/logo_collins.png"
                        alt="" width="100" />
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input class="form-control" id="phone" type="tel" placeholder="Teléfono *"
                                required="required" data-validation-required-message="Ingresa tu número de teléfono." />
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group mb-md-0">
                            <div class="input-group input-file mt-n5" name="Fichero">
                                <input type="text" class="form-control" placeholder='Seleccionar archivo... (Opcional)' />			
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-4 text-lg-right my-0">
                    ...
                    <p><a
                            href="mailto:construccionesgdladmon@gmail.com?Subject=Contacto%20Web">construccionesgdladmon@gmail.com</a>
                    </p>
                </div>
            </div>
        </div>
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="img-fluid d-block mx-auto"
                                src="assets/img/portfolio/AmpliacionNaves/Captura11.PNG" />
                        </div>
                        <div class="carousel-item">
                            <img class="img-fluid d-block mx-auto"
                                src="assets/img/portfolio/AmpliacionNaves/Captura9.png" />
                        </div>
                        <div class="carousel-item">
                            <img class="img-fluid d-block mx-auto"
                                src="assets/img/portfolio/AmpliacionNaves/Captura10.PNG" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-content bg-dark2">
                <div id="carouselModal3" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="img-fluid d-block mx-auto"
                                src="assets/img/portfolio/PisoConcreto/Captura9.PNG" />
                        </div>
                        <div class="carousel-item">
                            <img class="img-fluid d-block mx-auto"
                                src="assets/img/portfolio/PisoConcreto/Captura8.PNG" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-content bg-dark2">
                <div id="carouselModal4" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="img-fluid d-block mx-auto"
                                src="assets/img/portfolio/PisoEpoxico/Epoxico1.jpg" />
                        </div>
                        <div class="carousel-item">
                            <img class="img-fluid d-block mx-auto"
                                src="assets/img/portfolio/PisoEpoxico/Epoxico2.jpg" />
                        </div>
                        <div class="carousel-item">
                            <img class="img-fluid d-block mx-auto"
                                src="assets/img/portfolio/PisoEpoxico/Captura10.PNG" />
                        </div>
                        <div class="carousel-item">
                            <img class="img-fluid d-block mx-auto"
                                src="assets/img/portfolio/PisoEpoxico/Captura9.PNG" />
                        </div>
                        <div class="carousel-item">
                            <img class="img-fluid d-block mx-auto"
                                src="assets/img/portfolio/PisoEpoxico/Captura8.PNG" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-content bg-dark2">
                <div id="carouselModal5" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="img-fluid d-block mx-auto"
                                src="assets/img/portfolio/PisoEpoxico/Captura1.PNG" />
                        </div>
                        <div class="carousel-item">
                            <img class="img-fluid d-block mx-auto"
                                src="assets/img/portfolio/PisoEpoxico/Captura2.PNG" />
                        </div>
                        <div class="carousel-item">
                            <img class="img-fluid d-block mx-auto"
                                src="assets/img/portfolio/PisoEpoxico/Captura3.PNG" />
                        </div>
                        <div class="carousel-item">
                            <img class="img-fluid d-block mx-auto"
                                src="assets/img/portfolio/PisoEpoxico/Captura4.PNG" />
                        </div>
                        <div class="carousel-item">
                            <img class="img-fluid d-block mx-auto"
                                src="assets/img/portfolio/PisoEpoxico/Captura5.PNG" />
                        </div>
                        <div class="carousel-item">
                            <img class="img-fluid d-block mx-auto"
                                src="assets/img/portfolio/PisoEpoxico/Captura6.PNG" />
                        </div>
                        <div class="carousel-item">
                            <img class="img-fluid d-block mx-auto"
                                src="assets/img/portfolio/PisoEpoxico/Captura7.PNG" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content bg-dark2">
                <div id="carouselModal6" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="img-fluid d-block mx-auto" src="assets/img/portfolio/LavadoTinas/Captura3.PNG"
                                alt="" />
                        </div>
                        <div class="carousel-item">
                            <img class="img-fluid d-block mx-auto" src="assets/img/portfolio/LavadoTinas/Captura2.PNG"
                                alt="" />
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-content bg-dark2">
                <div id="carouselModal7" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="img-fluid d-block mx-auto"
                                src="assets/img/portfolio/EstructuraBarcel/EstructuraBarcel1.jpg" alt="" />
                        </div>
                        <div class="carousel-item">
                            <img class="img-fluid d-block mx-auto"
                                src="assets/img/portfolio/EstructuraBarcel/EstructuraBarcel2.jpg" alt="" />
                        </div>
                        <div class="carousel-item">
                            <img class="img-fluid d-block mx-auto"
                                src="assets/img/portfolio/EstructuraBarcel/EstructuraBarcel3.jpg" alt="" />
                        </div>
                        <div class="carousel-item">
                            <img class="img-fluid d-block mx-auto"
                                src="assets/img/portfolio/EstructuraBarcel/EstructuraBarcel4.PNG" alt="" />
                        </div>
                        <div class="carousel-item">
                            <img class="img-fluid d-block mx-auto"
                                src="assets/img/portfolio/EstructuraBarcel/EstructuraBarcel7.PNG" alt="" />
                        </div>
                    </div>
                </div>
            </div>
